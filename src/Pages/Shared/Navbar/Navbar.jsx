  ...
  return (
    <div className="w-full top-0 left-0 border-b fixed z-10 ">
      <div className="md:flex bg-white items-center gap-x-16 py-6 ">
        ...
        <div ref={menuRef}>
          <ul
            className={`md:flex md:items-center md:pb-0 pb-8 absolute md:static md:z-auto z-50 shadow-md md:shadow-none right-5 w-[220px] md:w-auto 
          md:pl-0 pl-9 transition-all duration-700 ease-in-out ${
            open ? "top-20" : "top-[-500px] "
          } opacity-100 bg-white border md:border-0
          shadow-stone-600`}
          >
            {links.map((link) => (
